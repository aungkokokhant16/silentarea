...
<div class="container-fluid">
      ...
      <div class="card shadow mb-4" id="Newdiv">
        ...
        <div class="card-body">
          <div class="row">
          <div class="col-lg-12">
            <form method="post" action="{{route('roomtype.update',$room->id)}}" class="m-5">
              @csrf
              @method('PUT')
              <div class="form-group">
                  <label for="name" class="mmfont"> Name </label>
                  <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="" name="name" value="{{$room->name}}">
                  @error('name')
                    <div class=" alert alert-danger">
                      <ul>
                        <li>{{ $message }}</li>
